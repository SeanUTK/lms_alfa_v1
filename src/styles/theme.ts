    ...
    return {
      ...
      colors: {
        ...
        background: {
          ...
          secondary: '#1e293b', // Slightly lighter (card background)
          tertiary: '#334155',  // Even lighter (for highlights)
          lighter: '#1e293b',   // For inputs
          light: '#334155',     // For hover states
          hover: '#475569'      // For hover effects
        },
        text: {
          primary: '#f8fafc',
          secondary: '#e2e8f0',
        ...
        border: {
          light: '#334155',     // Updated for better visibility
          lighter: '#475569',
          dark: '#1e293b'
        },
        shadow: {
          sm: '0 1px 2px 0 rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(255, 255, 255, 0.07)',
          DEFAULT: '0 1px 3px 0 rgba(0, 0, 0, 0.7), 0 1px 2px 0 rgba(0, 0, 0, 0.6), 0 0 0 1px rgba(255, 255, 255, 0.07)',
          md: '0 4px 6px -1px rgba(0, 0, 0, 0.7), 0 2px 4px -1px rgba(0, 0, 0, 0.6), 0 0 0 1px rgba(255, 255, 255, 0.07)',
          lg: '0 10px 15px -3px rgba(0, 0, 0, 0.7), 0 4px 6px -2px rgba(0, 0, 0, 0.6), 0 0 0 1px rgba(255, 255, 255, 0.07)',
          xl: '0 20px 25px -5px rgba(0, 0, 0, 0.7), 0 10px 10px -5px rgba(0, 0, 0, 0.6), 0 0 0 1px rgba(255, 255, 255, 0.07)',
          '2xl': '0 25px 50px -12px rgba(0, 0, 0, 0.8), 0 0 0 1px rgba(255, 255, 255, 0.07)',
          inner: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.7)',
          none: 'none',
        }
      },
      shadows,
