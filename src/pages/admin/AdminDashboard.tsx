...
import { Card, Button, LineChart, BarChart, PieChart, Loader } from '../../components/ui';
  ...
  return (
    <AdminLayout>
      <DashboardContainer>
        ...
        <ChartsGrid>
          <ChartCard title="Enrollment Trends" subtitle="Monthly student and course enrollment">
            <LineChart data={enrollmentData} height={300} />
          </ChartCard>
          <ChartCard title="Revenue" subtitle="Monthly revenue in USD">
            <BarChart data={revenueData} height={300} />
          </ChartCard>
        </ChartsGrid>

        <BottomGrid>
          <ChartCard title="Course Distribution" subtitle="By category">
            <PieChart data={courseDistributionData} height={240} />
          </ChartCard>
