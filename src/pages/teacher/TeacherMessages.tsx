...
const MessageBubble = styled.div<MessageBubbleProps>`
  ...
  background-color: ${props => props.$isCurrentUser ? props.theme.colors.primary[500] : props.theme.colors.background.secondary};
...
const SendButton = styled(ComposerActionButton)<{ disabled: boolean }>`
  color: ${props => props.disabled ? props.theme.colors.text.tertiary : props.theme.colors.primary[500]};
